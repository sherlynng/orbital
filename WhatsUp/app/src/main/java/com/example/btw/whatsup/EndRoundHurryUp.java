...
public class EndRoundHurryUp extends Activity implements View.OnClickListener {
        ...
        listener = currentGameDb.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(game.getState().equals("ENDGAME")){
                    ...
                    Toast.makeText(EndRoundHurryUp.this, "Multiplayer game exited", Toast.LENGTH_SHORT).show();
                    backToMainMenu();
                    return;
                }
