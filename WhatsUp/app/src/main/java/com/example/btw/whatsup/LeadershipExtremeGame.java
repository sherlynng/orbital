...
public class LeadershipExtremeGame extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        best_score = gameDataExtreme.getInt("bestScore", 0);
        ...
        game_type.setText("Extreme Game");
...
//getting the reference of artists node
        databaseGames = FirebaseDatabase.getInstance().getReference("leadership_board").child("extreme");
