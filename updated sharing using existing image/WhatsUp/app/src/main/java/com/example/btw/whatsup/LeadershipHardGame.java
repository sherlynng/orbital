...
public class LeadershipHardGame extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        best_score = gameDataHard.getInt("bestScore", 0);
...
//getting the reference of artists node
        databaseGames = FirebaseDatabase.getInstance().getReference("leadership_board").child("hard");
